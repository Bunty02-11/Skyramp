                        ...
                        <main>
                            ...
                            <div className="tp-service-2-area pt-140 pb-45">
                                <div className="container">
                                    <div className="row">
                                        <div
                                            className="col-xl-4 col-lg-4 col-md-6 mb-90  wow tpfadeUp"
                                            ...
                                            <div className="tp-service-2-item">
                                                ...
                                                <div className="tp-service-2-content">
                                                    ...
                                                    <div className="tp-service-2-text">
                                                        <p>
                                                            Ut elementum sergeoi mollis eu sapien neque des tempus
                                        ...
                                        >
                                            <div className="tp-service-2-item active">
                                                ...
                                                <div className="tp-service-2-content">
                                                    <h4 className="tp-service-2-title">
                                                        <a href="service-details.html"> Art and Decor Curation</a>
                                                    </h4>
                                                    <div className="tp-service-2-text">
                                                        <p>
                                                            Ut elementum sergeoi mollis eu sapien neque des tempus
                                        ...
                                        >
                                            <div className="tp-service-2-item">
                                                ...
                                                <div className="tp-service-2-content">
                                                    <h4 className="tp-service-2-title">
                                                        <a href="service-details.html">Luxury Interior Design</a>{" "}
                                                    </h4>
                                                    <div className="tp-service-2-text">
                                                        <p>
                                                            Ut elementum sergeoi mollis eu sapien neque des tempus
                                        ...
                                        >
                                            <div className="tp-service-2-item">
                                                ...
                                                <div className="tp-service-2-content">
                                                    <h4 className="tp-service-2-title">
                                                        <a href="service-details.html">Craft Dream Space</a>
                                                    </h4>
                                                    <div className="tp-service-2-text">
                                                        <p>
                                                            Ut elementum sergeoi mollis eu sapien neque des tempus
                                        ...
                                        >
                                            <div className="tp-service-2-item">
                                                ...
                                                <div className="tp-service-2-content">
                                                    <h4 className="tp-service-2-title">
                                                        <a href="service-details.html">Shine Personality</a>
                                                    </h4>
                                                    <div className="tp-service-2-text">
                                                        <p>
                                                            Ut elementum sergeoi mollis eu sapien neque des tempus
                                        ...
                                        >
                                            <div className="tp-service-2-item">
                                                ...
                                                <div className="tp-service-2-content">
                                                    <h4 className="tp-service-2-title">
                                                        <a href="service-details.html">Power Design</a>
                                                    </h4>
                                                    <div className="tp-service-2-text">
                                                        <p>
                                                            Ut elementum sergeoi mollis eu sapien neque des tempus
