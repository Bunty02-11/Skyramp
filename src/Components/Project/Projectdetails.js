                                    ...
                                    <div className="eow">
                                        <div className="col-xl-12">
                                            <div className="tp-project-details-thumb">
                                                <img src="assets/img/project/details1-1.jpg" alt="" />
                                            </div>
                                            <div className="row">
                                                    ...
                                                    <div className="tp-project-details-left-box">
                                                        <ul>
                                                            <li>
                                                                ...
                                                                Contractin investor: Privet owner
                                                            </li>
                                                            <li>
                                                                <span>
                                                                    <svg
                                                                ...
                                                                Contructing date: December 2022
                                                            </li>
                                                            <li>
                                                                <span>
                                                                    <svg
                                                ...
                                                <div className="col-xl-8 col-lg-8">
                                                    <div className="tp-project-details-content pt-45">
                                                        <h5 className="tp-project-details-title pb-20">
                                                            Experience with Interior Innovations
                                                        </h5>
                                                        <p className="mb-0">
                                                            Aliquam eros justo, posuere loborti vive rra laoreet
                                                            matti ullamc orper posu ere viverra .Aliquam eros justo,
                                                            posuere lobortis non, vive rra laoreet augue mattis
                                                            fermentum ullamcorper viverra Aliquam eros justo,
                                                            posuere loborti vive rra laoreet matti ullamc orper posu
                                                            ere viverra .Aliquam eros justo, posuere lobortis non,
                                                            vive rra laoreet augue mattis fermentum ullamcorper
                                                            viverra Aliquam eros justo, posuere loborti vive rra
                                                            laoreet matti ullamc orper posu ere viverra .Aliquam
                                                            eros justo, posuere lobortis non, vive rra laoreet augue
                                                            mattis
                                                        </p>
                                                    </div>
                                                </div>
                                            ...
                                            <div className="tp-project-details-text pt-30 pb-30">
                                                <p>
                                                    ...
                                                    lobortis, viverra laoreet augue mattis viverra fermentum
                                                    ...
                                                    viverra .Aliquam eros justo, posuere lobortis, viverra
                                                    laoreet augue mattis fermentum viverra .Aliquam eros justo,
                                            ...
                                            <div className="row">
                                                <div className="col-xl-6 col-lg-6 mb-35">
                                                    <div className="tp-project-details-thumb">
                                                        <img src="assets/img/project/details1-2.jpg" alt="" />
                                                    </div>
                                                </div>
                                                <div className="col-xl-6 col-lg-6 mb-35">
                                                    <div className="tp-project-details-thumb">
                                                        <img src="assets/img/project/details1-3.jpg" alt="" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="tp-project-details-content">
                                                <h5 className="tp-project-details-title pb-25">
                                                    Unleash Your Creativity with Interior Inspiration
                                                </h5>
                                                <p>
                                                    ...
                                                    .Aliquam eros justo, posuere lobortis non, viverra laoreet
                                                    augue mattis. Aliquam eros justo, posuere loborti viverra
                                                    laoreet matti ullamcorper posuere viverra justo, posuere
                                                    loborti viverra laoreet matti ullamcorper posuere viverra.
                                                </p>
                                            </div>
                                            <div className="tp-project-details-list pb-5">
                                                <ul>
                                                    ...
                                                    <li>Make Your House a Home with Interior Perfection</li>
                                                    <li>
                                                        Enhance Your Lifestyle with Exceptional Interior Design
                                                    </li>
                                                    <li>Experience the Power of Thoughtful Interior Design</li>
                                                </ul>
                                            </div>
